 ...
 * Description: A dead-simple minimum order tab for your Woocommerce store. Go to your Woocommerce settings section to find the Simple Woocommerce Minimum Order tab.
...
class WC_Min_Order {
    ...
    public static function add_settings_tab( $settings_tabs ) {
        $settings_tabs['settings_tab'] = __( 'Simple Woocommerce Minimum Order', 'wc-simple-min-order' );
    ...
    public static function get_option() {
        $settings = array(
            'section_title' => array(
                'name'     => __( 'Simple Woocommerce Minimum Order', 'wc-simple-min-order' ),
                'type'     => 'title',
                'desc'     => '',
                'id'       => 'wc_min_order_section_title'
            ),
            'title' => array(
                'name' => __( 'Minimum Order Amount', 'wc-simple-min-order' ),
                'type' => 'text',
                'css'  => 'max-width: 100px;',
                'desc' => __( 'All orders must be greater than or equal to the amount in this field.', 'wc-simple-min-order' ),
